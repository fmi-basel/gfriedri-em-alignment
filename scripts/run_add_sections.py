...
@flow(
    ...
    task_runner=DaskTaskRunner(
        ...
        cluster_kwargs={
            ...
            "job_script_prologue": "conda run -p "
            "/tungstenfs/scratch/gmicro_share/_prefect/miniconda3/envs/airtable python /tungstenfs/scratch/gmicro_share/_prefect/airtable/log-slurm-job.py --config /tungstenfs/scratch/gmicro/_prefect/airtable/slurm-job-log.ini",
        },
        adapt_kwargs={
            "minimum": 1,
            "maximum": 1,
